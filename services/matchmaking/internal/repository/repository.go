...
type InternalRepository interface {
	...
	RecommendRooms(ctx context.Context, preferences domain.MatchmakingPreferences) (domain.ListResponse[domain.RoomRecommendation], error)
...
type SessionRepository interface {
	GetRoomRecommendations(ctx context.Context, key string) (domain.ListResponse[domain.RoomRecommendation], error)
	SetRoomRecommendations(ctx context.Context, key string, recommendations domain.ListResponse[domain.RoomRecommendation], ttl time.Duration) error
