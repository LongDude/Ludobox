...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'gameRoom.controls.boostHint': 'Purchase or cancel boost for the current participant.',
    'gameRoom.controls.boostDisabled': 'Boost is disabled or room metadata is not available.',
    'gameRoom.controls.boostValue': 'Boost value',
    'gameRoom.controls.buyBoost': 'Buy boost',
    'gameRoom.controls.cancelBoost': 'Cancel boost',
    'gameRoom.controls.roomTitle': 'Room lifecycle',
    'gameRoom.controls.roomHint': 'Leave releases the current participant before the game starts.',
  ...
  ru: {
    ...
    'gameRoom.controls.boostHint': 'Покупка или отмена буста для текущего участника.',
    'gameRoom.controls.boostDisabled': 'Буст отключён или метаданные комнаты недоступны.',
    'gameRoom.controls.boostValue': 'Значение буста',
    ...
    'gameRoom.controls.roomHint': 'Выход освобождает текущего участника до старта игры.',
