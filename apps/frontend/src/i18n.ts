...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'gameRoom.controls.roomHint': 'Leave releases all your active seats before the game starts.',
  ...
  ru: {
    ...
    'gameRoom.controls.roomHint': 'Выход освобождает все ваши активные места до старта игры.',
