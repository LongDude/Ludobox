...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'gameRoom.entry.description':
      'Use automatic seating or pick a concrete seat to test the game_server join endpoints.',
    ...
    'gameRoom.entry.addSeatHint': 'You occupy {count} of {limit} allowed seats. Pick a free seat or use automatic seating.',
  ...
  ru: {
    ...
    'gameRoom.entry.description':
      'Используйте автоматическое место или выберите конкретное место для теста endpoint-ов game_server.',
    ...
    'gameRoom.entry.addSeatHint': 'Вы заняли {count} из {limit} доступных мест. Выберите свободное место или автопосадку.',
