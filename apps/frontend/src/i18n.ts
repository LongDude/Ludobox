...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'gameRoom.round.description': 'Polls the current round state through the room-scoped game_server API.',
  ...
  ru: {
    ...
    'gameRoom.round.description': 'Опрос текущего состояния раунда через room-scoped API game_server.',
