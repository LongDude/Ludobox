...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'profile.history.roundSummary': 'Round #{round} - room #{room}',
    'profile.history.meta.seats': 'Reserved seats',
    'profile.history.meta.winningSeats': 'Winning seats',
    'profile.history.meta.totalSpent': 'Spent',
    ...
    'profile.history.seatsSummary': '{count} seats: {seats}',
    'profile.history.seatsWinningSummary': '{count} winning seats: {seats}',
    'profile.history.seatsNone': 'None',
    ...
    'gameRoom.messages.leftRoom': 'You left the room. All waiting reservations were cancelled. Refund: {refund}.',
    'gameRoom.messages.joinedPartialAvailable':
      'Reserved {count} random seats out of {requested} requested. Seats: {seats}.',
    ...
    'gameRoom.confirmLeaveRoom': 'Leave the room and cancel all your waiting reservations?',
    ...
    'gameRoom.controls.roomHint':
      'Before the game starts you can leave the room completely, which cancels all your reserved seats for the waiting round.',
  ...
  ru: {
    ...
    'gameRoom.controls.actionsLocked': 'Проходит раунд',
